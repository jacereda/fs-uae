...
static void gd5429_update_irqs(gd5429_t *gd5429)
{
    if (gd5429->vblank_irq > 0 && gd5429_vga_vsync_enabled(gd5429))
        pci_set_irq(0, PCI_INTA);
    else
        pci_clear_irq(0, PCI_INTA);
}
...
static void gd5429_out(uint16_t addr, uint8_t val, void *p)
{
...
static uint8_t gd5429_in(uint16_t addr, void *p)
{
        gd5429_t *gd5429 = (gd5429_t *)p;
        svga_t *svga = &gd5429->svga;
        uint8_t ret;
...
static void gd5429_recalctimings(svga_t *svga)
{
        gd5429_t *gd5429 = (gd5429_t *)svga->p;
...
static void gd5429_hwcursor_draw(svga_t *svga, int displine)
{
        gd5429_t *gd5429 = (gd5429_t *)svga->p;
        int x;
        uint8_t dat[2];
...
static void gd5429_start_blit(uint32_t cpu_dat, int count, void *p)
{
        gd5429_t *gd5429 = (gd5429_t *)p;
        svga_t *svga = &gd5429->svga;
...
static uint8_t ibm_gd5428_mca_read(int port, void *p)
{
        gd5429_t *gd5429 = (gd5429_t *)p;
...
static void ibm_gd5428_mca_write(int port, uint8_t val, void *p)
{
...
static void gd5429_close(void *p)
{
        gd5429_t *gd5429 = (gd5429_t *)p;
...
static void gd5429_speed_changed(void *p)
{
        gd5429_t *gd5429 = (gd5429_t *)p;
...
static void gd5429_force_redraw(void *p)
{
        gd5429_t *gd5429 = (gd5429_t *)p;
...
static void gd5429_add_status_info(char *s, int max_len, void *p)
{
        gd5429_t *gd5429 = (gd5429_t *)p;
